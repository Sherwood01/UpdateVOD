...
VOD_SOURCES = [
    ...
    {"url": "https://vod.xwqin.com/output/20.json", "output": "20.json"},
    {"url": "https://vod.xwqin.com/output/98.json", "output": "98.json"},
    {"url": "https://vod.xwqin.com/output/118.json", "output": "118.json"}
]
